  ...
  const projects = [
    {
      ...
      moreText: [
        'Full stack application provides dual permission functionality for a boutique company to manage product inventory. General user can read, filter and run reports. Manager has full CRUD permissions.', 'Front end code base is React with Context API, deployed on Netlify. Back end is Spring Boot with several packages to handle authentication, session management, and password encyrption. Spring Boot application is containerized and deployed on AWS. Deploy link available upon request.',
      ],
    },
    {
      id: 2,
      image: travelSite,
      title: 'Visit Taniti',
      subheader: 'WGU UX Design Project: Prototype',
    ...
    },
    {
      ...
      image: takeCare,
      title: 'Take Care',
      subheader: 'Flatiron School capstone project',
      link: 'https://youtu.be/Fhb1zT1z-WQ',
      buttonText: 'Demo (on YouTube)',
      moreText:
        ['Full stack project (React and Ruby on Rails): Take Care is a self-care journaling app that allows the user to sign up/log in, create a profile, peruse a list of self-care activities, save, update and delete journal entries pertaining to those activities as well as create original activities. Also uses an external API to generate daily affirmations via a "roulette" affirmation button.'],
    },
    {
      id: 7,
      image: petDates2,
      title: 'Pet Dates',
      subheader: 'Flatiron School JavaScript Project - because pets need friends too!',
      link: 'https://youtu.be/uolpe_CaOec',
      buttonText: 'Demo (on YouTube)',
      moreText:
        ['Full stack project (JS and Ruby on Rails): Recently refactored to all OOP with loads of new functionality added. This pet-date scheduler is currently being used by dogs, cats, a gecko and a stuffed raccoon.'],
    },

    {
      ...
      subheader: "A wine and cupcake app... you're welcome, world!",
      link: 'https://mishelbyt.github.io/brelbys-sass/practice-project/dist/',
      buttonText: 'Deployed Site',
      moreText:
        ["JS with SASS (riffed off of a SASS tutorial from CodeStackr). This app is lovingly adapted from a Flatiron School project created with my wonderful friend Bryn Knowles. Brelby's lives!"],
    },
    {
      id: 9,
      image: ttt,
      ...
      buttonText: 'Deployed Site',
      moreText:
        ["Riffed off of a React tutorial for a basic tic tac toe game, I've added features including scorekeeping and game control. Submitted to Mintbean as first ever hackathon, first game build, first deployment."],
    },
  ]
